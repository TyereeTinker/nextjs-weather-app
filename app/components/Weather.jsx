...
const Weather = ({data}) => {
    ...
    console.log(data)
    return (
        <div className='relative flex flex-col justify-between max-w-[500px] w-full h-[80vh] m-auto mt-2 mb-2 p-4 text-gray-300 z-10 border border-gray-300 rounded-2xl' >
            {/* Top */}
